...
func bootstrapIAAS(
	...
	logger.Criticalf("bootstrapIAAS args %#v", args)
	logger.Criticalf("bootstrapIAAS bootstrapParams %#v", bootstrapParams)
	cfg := environ.Config()
	...
	logger.Criticalf("bootstrapIAAS bootstrapParams.JujuDbSnapPath:           %v", args.JujuDbSnapPath)
	logger.Criticalf("bootstrapIAAS bootstrapParams.JujuDbSnapAssertionsPath: %v", args.JujuDbSnapAssertionsPath)
	if err := instanceConfig.SetSnapSource(args.JujuDbSnapPath, args.JujuDbSnapAssertionsPath); err != nil {
		return errors.Trace(err)
	}
	logger.Criticalf("bootstrapIAAS instanceConfig.Bootstrap.JujuDbSnapPath:           %v", instanceConfig.Bootstrap.JujuDbSnapPath)
	logger.Criticalf("bootstrapIAAS instanceConfig.Bootstrap.JujuDbSnapAssertionsPath: %v", instanceConfig.Bootstrap.JujuDbSnapAssertionsPath)
